<script lang="ts">
  ...
  import { Rocket, Trash2, X, Activity, LayoutGrid, Folder, Search, Monitor, Play, Settings2 } from 'lucide-svelte';
  ...
  const keyboardRows: KeyInfo[][] = [
    ...
    // Row 5: ZXCV
    [
      { code: 'ShiftLeft', label: 'Shift', width: 2.4 }, { code: 'KeyZ', label: 'Z' }, { code: 'KeyX', label: 'X' }, { code: 'KeyC', label: 'C' },
      { code: 'KeyV', label: 'V' }, { code: 'KeyB', label: 'B' }, { code: 'KeyN', label: 'N' }, { code: 'KeyM', label: 'M' },
      { code: 'Comma', label: ',' }, { code: 'Period', label: '.' }, { code: 'Slash', label: '/' }, { code: 'ShiftRight', label: 'Shift', width: 2.6 },
    ],
    // Row 6: Space
    [
      { code: 'ControlLeft', label: 'Ctrl', width: 1.2 }, { code: 'MetaLeft', label: 'Win', width: 1.2 }, { code: 'AltLeft', label: 'Alt', width: 1.2 },
      { code: 'Space', label: 'Space', width: 6 },
      { code: 'AltRight', label: 'Alt', width: 1.2 }, { code: 'MetaRight', label: 'Win', width: 1.2 }, { code: 'ContextMenu', label: 'Menu', width: 1.2 },
